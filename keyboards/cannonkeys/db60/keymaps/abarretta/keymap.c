...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_ansi(
    ...
    FN2_CAPS,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,             KC_ENT,
  ...
  [_COLEMAK] = LAYOUT_60_ansi(
    ...
    FN2_CAPS,   KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,             KC_ENT,
  ...
  [_FN1] = LAYOUT_60_ansi(
    ...
    KC_RCTL,    KC_RGUI, KC_RALT,                            _______,                            _______, _______,  _______,  TG(1)
  )
};
